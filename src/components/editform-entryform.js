		...
		<section id='entry-page'>
			...
			{errorMessage}
				...
				<fieldset className='form-center' name='expense-info'>
					...
					<Field id='category' value='Front-end HTML' name='category' component='select' role='option' 
					aria-selected='true' aria-live='polite' required>
					...
					/>
		      		...
		      		<Link to='/library'><button id='abortBtn' type='submit' aria-label='Close'>
...
const mapStateToProps = (state, ownProps) => {
	let combinedArr = [].concat(
		state.protectedData.htmldata.bookmarks,
		state.protectedData.cssdata.bookmarks,
		state.protectedData.jsdata.bookmarks,
		state.protectedData.feframedata.bookmarks,
		state.protectedData.feotherdata.bookmarks,
		state.protectedData.begeneraldata.bookmarks,
		state.protectedData.beframedata.bookmarks,
		state.protectedData.beotherdata.bookmarks,
		state.protectedData.testingdata.bookmarks,
		state.protectedData.otherdata.bookmarks
	)
